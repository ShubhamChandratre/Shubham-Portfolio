...
import myImg from "../../Assets/Profilephoto1.jpg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I like to code for real world solutions which have a impact on the society.
              <br />
          ...
          <Col md={4} className="myAvtar">
            ...
            <Tilt>
            <img src={myImg} className="img-fluid" alt="avatar" style={{ width: "330px", height: "330px" }} />
            </Tilt>
